...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  const sections = [
    ...
    },
    {
      ...
      title: '兴趣与影音',
      subtitle: '4K 视频与流媒体墙',
      desc: '记录城市流光航拍、极简 4K 桌面搭建与指弹吉他 Live，分享生活中的审美灵感。',
      icon: Film,
  ...
  return (
    <div className="space-y-16 py-6 animate-fade-in">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 p-8 sm:p-12 md:p-16 border border-slate-800 shadow-2xl">
        ...
        <div className="absolute top-0 right-0 -mt-12 -mr-12 w-96 h-96 rounded-full bg-indigo-600/15 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 -mb-12 -ml-12 w-96 h-96 rounded-full bg-purple-600/15 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 text-xs font-semibold">
            ...
            <span>Welcome to Zenith Digital Garden</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
            探索代码架构、<br />
            <span className="gradient-text">视觉审美与文字力量</span>
          </h1>

          <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-2xl">
            欢迎来到我的个人数字花园。这里集成了学习 Markdown 笔记、4K 兴趣视频、3D 电子书架以及个人项目作品。
          </p>

          <div className="flex flex-wrap gap-4 pt-4">
            <button
              onClick={() => onNavigate('learning')}
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium text-sm hover:from-indigo-500 hover:to-purple-500 transition-all shadow-lg shadow-indigo-600/25 flex items-center space-x-2"
            >
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-indigo-300 mt-0.5">{sec.subtitle}</p>
                ...
                <div className="mt-6 pt-4 border-t border-slate-800/60 flex items-center text-xs font-semibold text-indigo-400 group-hover:translate-x-1 transition-transform">
                  <span>进入板块</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {posts.slice(0, 3).map((post) => (
            <article
              ...
              className="glass-panel rounded-2xl overflow-hidden border border-slate-800 hover:border-slate-700 cursor-pointer group flex flex-col justify-between transition-all duration-300"
            >
              {post.coverImage && (
              ...
              <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-slate-100 text-base group-hover:text-indigo-400 transition-colors line-clamp-2">
                    {post.title}
                  </h3>
      ...
      {/* Featured Videos & Books Quick Carousel/Grid */}
            ...
            {videos.slice(0, 2).map((vid) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-semibold text-slate-200 group-hover:text-purple-300 truncate">
                    {vid.title}
                  </h4>
          ...
          <div className="space-y-3">
            {books.slice(0, 2).map((bk) => (
              ...
              >
                ...
                />
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-semibold text-slate-200 group-hover:text-blue-300 truncate">
                    {bk.title}
                  </h4>
