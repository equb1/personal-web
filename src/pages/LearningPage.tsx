...
import { Search, Calendar, Eye, ThumbsUp, ArrowLeft, BookOpen, Clock } from 'lucide-react'
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-8 py-6 animate-fade-in">
        ...
        <button
          ...
          className="inline-flex items-center space-x-2 px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:border-teal-500/40 text-slate-300 hover:text-white transition-all text-sm"
        >
