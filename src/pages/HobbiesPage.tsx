...
import { Film, Play, Eye, Calendar, Clock, Sparkles } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredVideos.map((video) => (
          <div
            ...
            className="glass-panel rounded-2xl overflow-hidden border border-slate-800 hover:border-purple-500/40 cursor-pointer group flex flex-col justify-between transition-all duration-300 hover:-translate-y-1"
          >
            ...
            <div className="relative aspect-video overflow-hidden bg-slate-950">
              ...
              {/* Top Badges */}
              <div className="absolute top-3 left-3 px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-slate-950/80 text-purple-300 backdrop-blur-md border border-slate-800 uppercase">
                {video.category}
              </div>
